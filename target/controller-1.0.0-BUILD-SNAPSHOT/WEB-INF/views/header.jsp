				...
				<ul class = "sub-menu-list">
					<li>
						...
						<form action="${pageContext.servletContext.contextPath }/login" method="post">
							...
							비밀번호<br><input type="password" name="user-pw"><br>
							<input type="hidden" value="" name="login-info">
					...
					<li><a href="${pageContext.servletContext.contextPath }/authuntification">
							
							<span class = "menu">인증</span>
						</a></li>
					<li><a href="${pageContext.servletContext.contextPath }/mypage">
		...
		<div class ="main-nav-left"> 
			...
			<div class = "sub-menu">
				<ul class = "sub-menu-list">
					...
					<li><a href="${pageContext.servletContext.contextPath }/authentification">
							<span class = "menu">인증</span>
						</a></li>
					<li><a href="${pageContext.servletContext.contextPath }/mypage">
							<span class = "menu">마이페이지</span>
