...
<script>
	function sendID() {
		var parentIdField = opener.document.getElementById("user_id");
   		var childIdField = document.getElementById("id");
...
<body>
	<form action="${pageContext.servletContext.contextPath }/EveryWedding/duplication_check" method="get">
