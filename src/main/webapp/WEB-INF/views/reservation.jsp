...
<c:set var="contextPath" value="${pageContext.servletContext.contextPath }"></c:set>
	...
	<section>
	<div id="div-search">
	<form action="${pageContext.servletContext.contextPath }/EveryWedding/total_search" method="post" accept-charset="UTF-8">
		<label id="label-style1">검색어</label>
		<input type="search" id="input-text-style1" name="search_word">
	...
	<form action="${pageContext.servletContext.contextPath }/EveryWedding/detail_search" method="post" accept-charset="UTF-8">
	<div id="toc-content">
				...
				<tr>
					<td style="position: relative;">
						<img alt="업체이미지" src="/resources/resource/ent/${ent.getEnt_id()}-1.jpg" id="main-img">
							<a href="${pageContext.servletContext.contextPath }/EveryWedding/detail?id=${ent.getEnt_id()}">
